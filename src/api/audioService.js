...
/**
 * Send audio file to NetSpeech API for voice activity detection
 * @param {File} file - Audio file to analyze
 * @returns {Promise<Object>} - NetSpeech analysis results with time intervals
 */
 ...
 * @param {File} file - Audio file to analyze
 * @returns {Promise<Object>} - SNR analysis results with score
 */
